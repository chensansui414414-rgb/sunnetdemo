...
document.addEventListener("DOMContentLoaded",()=>{ document.querySelectorAll("[role=tab]").forEach(tab=>tab.addEventListener("click",()=>{activePeriod=tab.dataset.period;render();})); render(); loadRealPair(); });
